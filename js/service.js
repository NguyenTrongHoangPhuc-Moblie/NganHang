...
function create_card() {
    ...
    if (check_color(color)) {
        ...
        document.getElementById("card_chip").getElementsByTagName("img")[0].src = "/images/icon/chip_white.png";
        ...
        document.getElementById("card_chip").getElementsByTagName("img")[0].src = "/images/icon/chip_black.png";
